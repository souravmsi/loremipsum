...
import { rtmAdvanceBidsSchema } from "../schemas";
import { z } from "zod";
...
const AdvanceBids = ({
    ...
    const { setValue, watch, register, getValues } = useForm<
        z.infer<typeof rtmAdvanceBidsSchema>
    >({
        defaultValues: {
            mode: "manual",
            client: {
    ...
    const handleSubmit = () => {
        ...
        const { success, error, data } =
            rtmAdvanceBidsSchema.safeParse(formData);
        if (success) {
            console.log(data);
